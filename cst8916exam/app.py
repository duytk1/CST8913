...
students = [
    {"id": 1, "name": "Alice", "grade": "25", "email": "test@gmail.com"},
    {"id": 2, "name": "Bob", "grade": "30", "email": "test2@gmail.com"},
]
...
def create_student():
    ...
    new_student = {
        ...
        'grade': request.json.get('grade', ""),  # The grade is optional; default is 0 if not provided
        'email': request.json.get('email', ""),  # The email is optional; default is 0 if not provided
    }
